...
(function(){
  const feed = [
    ...
    { id:"uy-ethics-01", title:"Uruguay organiza foro regional sobre IA responsable", summary:"Participan reguladores, academia y empresas para discutir estándares y cooperación.", url:"https://elpais.com.uy/tecnologia/foro-ia-responsable", source:"El País Uruguay", source_url:"https://www.elpais.com.uy/", country:"Uruguay", topics:["Ética","Regulación"], language:"es", published_at:"2025-08-27T10:00:00Z", relevance:4, sentiment:"neutral", curator:"Codex 1" },
  ...
  const agents = [
    { nombre:"Codex 1", estado:"Activo", ultimo_ejecucion:"", throughput:"—", notas:"AI News Researcher" }
  ];
